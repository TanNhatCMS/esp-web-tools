  ...
  public connectedCallback() {
    ...
    if (!InstallButton.isSupported || !InstallButton.isAllowed) {
      ...
      this.renderRoot.innerHTML = !InstallButton.isAllowed
        ...
        : "<slot name='unsupported'>Your browser does not support installing things on ESP devices. Use Mozilla Firefox, Google Chrome or Microsoft Edge (Desktop) or Chrome on Android with USB OTG.</slot>";
      return;
    }
